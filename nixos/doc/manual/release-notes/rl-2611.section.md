...
- [BlueFerry](https://github.com/erikwb/blueferry), a bridge that brings iPhone messages and notifications to Linux over Bluetooth. Available as [programs.blueferry](#opt-programs.blueferry.enable)
